...
export default async function DashboardPage() {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Current Month Collection Banner */}
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
          ...
          <div>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 800, color: 'var(--foreground)', marginBottom: '0.25rem' }}>
              {currentMonthNameBn} {currentYearNum} মাসের চাঁদা সংগ্রহ
            </h3>
            <p style={{ fontSize: '0.85rem', color: '#6b7280', margin: 0, fontWeight: 500 }}>
              {isLate 
                ? '১০ তারিখ পার হয়ে গেছে — বকেয়াদারদের বিলম্ব ফি প্রযোজ্য' 
                : '১০ তারিখের মধ্যে মাসিক চাঁদা পরিশোধ করুন'
              }
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', flex: 1, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <div style={{ 
              ...
              <span style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--success)', lineHeight: 1 }}>{currentMonthPaidCount}</span>
              <span style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--success)', marginTop: '0.25rem' }}>পরিশোধ</span>
            </div>
            ...
            <div style={{ 
              ...
              <span style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--danger)', lineHeight: 1 }}>{currentMonthDueCount}</span>
              <span style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--danger)', marginTop: '0.25rem' }}>বকেয়া</span>
            </div>
          </div>
